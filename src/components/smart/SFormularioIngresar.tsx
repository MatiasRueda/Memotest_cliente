...
function SFormularioIngresar(props: { enviarInformacion: (data: any) => void , cancelar?: (volumen?: number) => void }): JSX.Element {
    return (
        <SFormulario id="form-ingresar" btnEnviar="Ingresar" 
            ...
            cancelar={props.cancelar? {texto: "Cancelar" , accion: props.cancelar} : undefined}>
                ...
                <SInput nombre="contrasenia" role="contrasenia" 
                        type="password" 
