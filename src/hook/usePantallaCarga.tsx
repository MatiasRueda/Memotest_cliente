...
export default function usePantallaCarga(pantallaInicial?: PANTALLA_CARGA): ControladorPantallas {
    const [ pantalla , setPantalla ] = useState<PANTALLA_CARGA>(pantallaInicial? pantallaInicial : PANTALLA_CARGA.ACTUAL);
