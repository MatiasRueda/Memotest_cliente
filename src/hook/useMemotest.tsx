...
function useMemotest(memotest: Memotest): UseMemotest {
  const [informacion, setInformacion] = useState<InformacionMemotest>(
    memotest.informacion
  );
  ...
  const descontarTiempoNivel = (): number => {
    ...
    if (!memotest.informacion.segNivel) memotest.finalizarJuego();
    setInformacion({ ...informacion, ...memotest.informacion });
  ...
  const descontarTiempoMemorizar = (): number => {
    ...
    if (!memotest.informacion.segMemorizar) memotest.finalizarMemorizado();
    setInformacion({ ...informacion, ...memotest.informacion });
